...
=============================
   ...
   python = uR""" 
 No realli! She was Karving her initials řn the mřřse with the sharpened end  
 of an interspace třřthbrush given her by Svenge - her brother-in-law -an Oslo
 dentist and star of many Norwegian mřvies: "The Hřt Hands of an Oslo         
 Dentist", "Fillings of Passion", "The Huge Mřlars of Horst Nordfink"..."""
   RU"""142 MEXICAN WHOOPING LLAMAS"""#<-Can you fit 142 llamas in a red box?
   n = u' HERMSGERVŘRDENBRŘTBŘRDA ' + """ YUTTE """
